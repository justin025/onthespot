    ...
    <div className="animate-[fadeIn_0.2s_ease-out]">
      ...
      <form onSubmit={save} className="border-t border-gray-200 pt-6 dark:border-neutral-800">
        ...
        <div className="grid gap-x-5 gap-y-3 sm:grid-cols-2">
          ...
          <label className="flex flex-col gap-1 text-xs font-medium text-gray-600 dark:text-neutral-400">Bitrate / quality<select value={draft.bitrate} onChange={(event) => setDraft((current) => ({ ...current, bitrate: event.target.value }))} className="ots-input w-full text-sm"><option value="1411">1411k</option><option value="320">320k</option><option value="256">256k</option><option value="128">128k</option></select></label>
